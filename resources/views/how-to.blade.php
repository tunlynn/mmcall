...
@section('content')
 ...
 border-radius: 8px; will-change: transform;">
            <iframe loading="lazy"
                ...
                src="https://www.canva.com/design/DAGbxRmdc00/c5Smfaqve0eM0saCumhRnA/watch?embed"
        ...
        @for ($i = 1; $i <= 13; $i++)
            <div class="mb-4">
                <img src="{{ asset('user-guide-images/' . $i . '.png') }}" alt="User Guide Image {{ $i }}"
        ...
        <ol>
            ...
            <li>သင့်ရဲ့ device တွင် Linphone application ကို install လုပ်ပါ။ (available for Windows, Mac, iOS, Android, and
                Linux)</li>
        </ol>

        <h3>အဆင့်(၂) Phone account ကို စတင်အသုံးပြုရန် အချက်အလက်များကို စစ်ဆေးပါ။</h3>
        <p>သင်၏အကောင့်ကို <a href="{{ url('/home') }}">MM-Call service</a> တွင် log in ဝင်ပြီးနောက် phone account
            အချက်အလက်များကို အောက်မှာဖော်ပြထားတဲ့အတိုင်း မြင်တွေ့ရမှာ ဖြစ်ပါတယ်။</p>
        <ul>
        ...
        <p>Linphone အကောင့်ကို အောင်မြင်စွာပြုလုပ်ပြီးသည်နှင့် တစ်ပြိုင်နက် ဖုန်းခေါ်ဆိုမှုများကို စတင်ပြုလုပ်နိုင်မှာ
            ဖြစ်ပါတယ်။</p>

        <h3>အဆင့်(၅) သင်၏လက်မိနစ်ကို စစ်ဆေးပါ။</h3>
        <p>ဖုန်းခေါ်ဆိုမှုအတွက် လက်ကျန်မိနစ်များကို စစ်ဆေးရန် ကျွန်ပ်တို့ website စာမျက်နှာရှိ balance section တွင်
            စစ်‌ဆေးနိုင်ပါသည်။</p>
    </div>
    <hr>
